...
const Component = ({ id, initState, ...props }) => {
    ...
    const { onMount, onUnmount, component } = useInterpolater(config, data);
    ...
    if (Component) {
        return <Component {...component.props}>{props.children}</Component>;
    } else {
